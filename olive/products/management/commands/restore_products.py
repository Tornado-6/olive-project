...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        olives = Category.objects.create(
            name="Olives", slug="olives", description="Fresh and cured olives"
        )
        ...
        for product_data in products:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    self.stdout.write(
                        self.style.WARNING(
                            f'Failed to download image for {product_data["name"]}'
                        )
                    )
        ...
        self.stdout.write(
            self.style.SUCCESS("Successfully restored products and categories")
        )
