...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for main_category, subcategories in categories.items():
            ...
            if created:
                self.stdout.write(self.style.SUCCESS(f'Created main category: {main_category}'))
            ...
            for subcategory in subcategories:
                ...
                if created:
                    self.stdout.write(self.style.SUCCESS(f'Created subcategory: {subcategory} under {main_category}'))
